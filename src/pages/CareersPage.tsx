            ...
            <div className="container mx-auto px-4 max-w-4xl">
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {[
                  ...
                  { icon: Award, title: "HGTV Credibility", desc: "Tell people you work for the company { icon: Award, title: "HGTV Credibility", desc: "Tell people you work for the company featured 5 times on Scott's Vacation House Rules." },." },
