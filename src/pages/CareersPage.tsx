            ...
            <div className="container mx-auto px-4 max-w-4xl">
              <div className="text-center mb-12">
                ...
                <p className="text-muted-foreground max-w-2xl mx-auto">
                  We've been featured on HGTV. We carry $5 million in insurance. We offer Perfect Finish Promise on every project. That level of commitment requires a certain kind of person.
                </p>
              </div>
            ...
            <div className="container mx-auto px-4 max-w-4xl">
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {[
                  ...
                  { icon: Award, title: "HGTV Credibility", desc: "Tell people you work for the company featured 5 times on Scott's Vacation House Rules." },
