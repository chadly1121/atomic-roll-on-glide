  ...
  const schema = {
    ...
    "@graph": [
      ...
      },
      {
        ...
        "description": "Owner of Roll On Painting with over 25 years of painting industry experience. Featured 5 times on HGTV's Scott's Vacation House Rules."
      }
    ]
  };
            ...
            <div className="container mx-auto px-4">
              <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-4xl mx-auto">
                {[
                  ...
                  { icon: Award, label: "HGTV Featured", { icon: Award, label: "HGTV Featured", desc: "5x on Scott's Vacation House Rules" }, },
