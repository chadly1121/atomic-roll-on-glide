        ...
        <main className="pt-16">
          ...
          <section className="bg-gradient-to-b from-atomic-navy to-atomic-navy/90 text-white py-16 md:py-24">
            <div className="container mx-auto px-4 text-center">
              <h1 className="text-3xl md:text-5xl font-bold mb-4">About Roll On Painting</h1>
              <p className="text-lg text-white/80 max-w-2xl mx-auto">Muskoka's trusted painting company since 2014. Over 25 years of industry expertise.</p>
            </div>
          </section>
