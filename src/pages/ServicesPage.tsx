...
const cards: ServiceCard[] = [
  ...
  { title: 'Exterior Painting', description: 'Durable coatings engineered for Muskoka winters, with a three-year workmanship warranty.', href: '/exterior-painting', image: '/lovable-uploads/dad95b14-ad28-4aab-ab8b-05f9a56458ec.webp', icon: Paintbrush },
