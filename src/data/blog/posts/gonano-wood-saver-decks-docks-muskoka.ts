// Article body for /blog/gonano-wood-saver-decks-docks-muskoka
// Loaded on demand by src/data/blog/content.ts so it never ships with the blog index.
const content = `<p>If you own a wood deck or dock in Muskoka, you already know the problem: moisture, moss, and constant maintenance. That slippery green buildup isn't just ugly—it's dangerous and damaging.</p>
