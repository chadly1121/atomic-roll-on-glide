// Article body for /blog/sansin-exterior-stains-decks-docks-muskoka
// Loaded on demand by src/data/blog/content.ts so it never ships with the blog index.
const content = `<p>If you've owned a wood deck or dock for more than one season, you already know the cycle:</p>
