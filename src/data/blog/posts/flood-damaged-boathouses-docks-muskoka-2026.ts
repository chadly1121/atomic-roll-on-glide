// Article body for /blog/flood-damaged-boathouses-docks-muskoka-2026
// Loaded on demand by src/data/blog/content.ts so it never ships with the blog index.
const content = `<p>If you've been watching the water rise this spring — and if you're a lakefront property owner in Huntsville, Bracebridge, or anywhere along the Muskoka River watershed — you already know how bad it's been.</p>
...
<p>Roll On Painting serves lakefront properties across Huntsville, Bracebridge, Port Carling, Lake of Bays, and 38 communities across Muskoka, Almaguin, Parry Sound, Georgian Bay and Orillia. Chad Gilchrist and his crew have 25+ years of experience with exactly this kind of exterior wood work, in exactly these conditions.</p>
