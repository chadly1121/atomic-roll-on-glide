/**
 * Location Hero Data — Landmark images and personalized notes for each location page
 * 
 * Uses free Unsplash images (licensed for commercial use) of Ontario landmarks and scenery.
 * Each location gets a unique background image and a personal "why we love working here" note.
 */

// Unsplash CDN base URLs for hero backgrounds
const IMGS = {
  muskokaLake: "https://images.unsplash.com/photo-1608745483861-e4f3cb3a13f1?w=1400&h=700&fit=crop&q=80",
  waterfall: "https://images.unsplash.com/photo-1508002461948-e612d8221021?w=1400&h=700&fit=crop&q=80",
  sunsetLake: "https://images.unsplash.com/photo-1649115727830-29b809d5c4f3?w=1400&h=700&fit=crop&q=80",
  autumnForest: "https://images.unsplash.com/photo-1760531485830-8f25e095164a?w=1400&h=700&fit=crop&q=80",
  islands: "https://images.unsplash.com/photo-1765321770186-e111d29622db?w=1400&h=700&fit=crop&q=80",
  dockLake: "https://images.unsplash.com/photo-1602765005019-ac454609b961?w=1400&h=700&fit=crop&q=80",
  kayakLake: "https://images.unsplash.com/photo-1499720565725-bd574541a3ee?w=1400&h=700&fit=crop&q=80",
  rockyShore: "https://images.unsplash.com/photo-1669583963654-de29421c5228?w=1400&h=700&fit=crop&q=80",
};
...
const heroData: Record<string, LocationHeroInfo> = {
  ...
  "painters-bracebridge": {
    heroImage: IMGS.waterfall,
    landmark: "Bracebridge Falls",
  ...
  "painters-baysville": {
    heroImage: IMGS.kayakLake,
    landmark: "Lake of Bays",
  ...
  "painters-milford-bay": {
    heroImage: IMGS.muskokaLake,
    landmark: "Lake Muskoka Shoreline",
  ...
  "painters-minett": {
    heroImage: IMGS.sunsetLake,
    landmark: "Lake Rosseau Sunset",
  ...
  "painters-port-sandfield": {
    heroImage: IMGS.islands,
    landmark: "The Channel Between Lakes",
  ...
  "painters-port-sydney": {
    heroImage: IMGS.dockLake,
    landmark: "Mary Lake & Port Sydney Dam",
  ...
  "painters-rosseau": {
    heroImage: IMGS.sunsetLake,
    landmark: "Rosseau General Store & Lake Rosseau",
  ...
  "painters-georgian-bay": {
    heroImage: IMGS.rockyShore,
    landmark: "Georgian Bay's Rugged Shoreline",
  ...
  "painters-lake-of-bays": {
    heroImage: IMGS.autumnForest,
    landmark: "Dwight Beach & Lake of Bays",
  ...
  "painters-burks-falls": {
    heroImage: IMGS.waterfall,
    landmark: "Magnetawan River Falls",
  ...
  "painters-dwight": {
    heroImage: IMGS.kayakLake,
    landmark: "Dwight Beach on Lake of Bays",
  ...
  "painters-emsdale": {
    heroImage: IMGS.dockLake,
    landmark: "South Magnetawan River",
  ...
  "painters-katrine": {
    heroImage: IMGS.autumnForest,
    landmark: "Katrine Forest Trails",
  ...
  "painters-magnetawan": {
    heroImage: IMGS.waterfall,
    landmark: "Magnetawan River & Lock",
  ...
  "painters-parry-sound": {
    heroImage: IMGS.islands,
    landmark: "Parry Sound Tower & 30,000 Islands",
    localLove: "Parry Sound is the gateway to the legendary 30,000 Islands, and the views from the town's observation tower are absolutely unforgettable. This is Bobby Orr's hometown, and the community carries that same winning spirit in everything they do. We love the diversity of painting projects here — from the colourful downtown storefronts to elegant waterfront homes overlooking the sound. Parry Sound's combination of natural beauty, rich history, and community pride makes every project here feel important and rewarding."
  },
  "painters-seguin": {
    heroImage: IMGS.dockLake,
    landmark: "Oastler Lake Provincial Park",
  ...
  "painters-the-archipelago": {
    heroImage: IMGS.islands,
    landmark: "30,000 Islands of Georgian Bay",
  ...
  "painters-britt": {
    heroImage: IMGS.rockyShore,
    landmark: "Georgian Bay Shore at Britt",
  ...
  "painters-nobel": {
    heroImage: IMGS.dockLake,
    landmark: "Nobel on Georgian Bay",
  ...
  "painters-pointe-au-baril": {
    heroImage: IMGS.islands,
    landmark: "Pointe au Baril Lighthouse & Islands",
  ...
  "painters-orillia": {
    heroImage: IMGS.kayakLake,
    landmark: "Orillia Waterfront on Lake Couchiching",
  ...
  "painters-ramara": {
    heroImage: IMGS.sunsetLake,
    landmark: "Lake Couchiching & Lake Simcoe",
  ...
  "painters-warminster": {
    heroImage: IMGS.autumnForest,
    landmark: "Simcoe County Countryside",
