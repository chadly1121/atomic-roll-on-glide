          ...
          <div className="mt-8 px-4">
            ...
            >
              ...
              <div className="flex flex-col gap-3">
                ...
                <a href={`tel:${businessInfo.phone.tel}`} data-analytics-location="gallery" className="atomic-button-secondary w-full text-center py-3.5 flex items-center justify-center gap-2">
