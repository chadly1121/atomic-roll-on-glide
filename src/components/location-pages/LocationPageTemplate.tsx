...
const getUniversalFaqs = (name: string) => [
  ...
  },
  {
    ...
    answer: `Every completed project with Roll On Painting includes our Perfect Finish Promise: two hours of complimentary touch-ups per year of ownership. If your walls get scuffed or nicked after we've finished, we'll come back and touch them up at no charge. No other ${name} painter offers this.`
  },
];
