...
const FreeTouchUpsButton = () => {
  ...
  return (
    <button
      ...
      aria-label="Perfect Finish Promise - two hours of complimentary touch-ups per year of ownership - Learn more"
    >
      <div className="relative flex items-center justify-center gap-2 rounded-full bg-gradient-to-r from-atomic-orange/10 via-white to-atomic-orange/10 px-3 py-2">
        <div className="text-center flex-1 min-w-0">
          ...
          <span className="block text-xs text-atomic-navy/80">Two hours of complimentary touch-ups per year of ownership</span>
        </div>
