...
const FreeTouchUpsButton = () => {
  ...
  return (
    <button
      ...
      aria-label="Three-year workmanship warranty, plus two hours of complimentary touch-ups per year of ownership - Learn more"
    >
      <div className="relative flex items-center justify-center gap-2 rounded-full bg-gradient-to-r from-atomic-orange/10 via-white to-atomic-orange/10 px-3 py-2">
        <div className="text-center flex-1 min-w-0">
          <span className="text-xs sm:text-sm font-bold text-atomic-navy block">3-YEAR WORKMANSHIP WARRANTY</span>
          <span className="block text-[11px] sm:text-xs text-atomic-navy/80 leading-tight">Plus 2 hours of touch-ups per year of ownership</span>
        </div>
