 ...
 * 
 * Reusable template for individual service pages with:
 * - SEO meta tags
...
const ServicePageTemplate: React.FC<ServicePageTemplateProps> = ({ service }) => {
  const serviceUrl = `${businessInfo.urls.website}/${service.slug}`;
  ...
  return (
    <>
      <Helmet>
        ...
        {/* Open Graph */}
        <meta property="og:title" content={`${service.name} | Roll On Painting`} />
        ...
        <header className="bg-atomic-navy text-white py-4">
          <div className="container mx-auto px-4 flex items-center justify-between">
            ...
            <a 
              ...
              className="inline-flex items-center gap-2 text-white hover:text-atomic-turquoise transition-colors"
            >
          ...
          {service.benefits && (
            <section className="py-12">
              <div className="container mx-auto px-4">
                <h2 className="text-2xl font-bold text-atomic-navy text-center mb-8">
                ...
                <div className="max-w-3xl mx-auto">
                  <ul className="grid sm:grid-cols-2 gap-4">
                    {service.benefits.map((benefit, idx) => (
                      ...
                      >
                        <CheckCircle className="w-5 h-5 text-atomic-turquoise flex-shrink-0 mt-0.5" />
              ...
              <div className="container mx-auto px-4">
                ...
                <div className="max-w-3xl mx-auto space-y-4">
                  {service.faqs.map((faq, idx) => (
                    ...
                    >
                      <h3 className="font-semibold text-atomic-navy mb-2">
                        {faq.question}
                      </h3>
        ...
        <footer className="bg-atomic-navy/95 text-white py-8">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-white/50 text-xs mt-2">
              {businessInfo.address.full} | WSIB Covered | $5M Liability Insurance
            </p>
            <div className="mt-4">
              <Link to="/service-areas" className="text-white/50 text-xs hover:text-white/70">
