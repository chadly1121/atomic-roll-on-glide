        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="atomic-shape relative">
            ...
            <div className="rounded-[2rem] overflow-hidden shadow-2xl transform hover:rotate-0 transition-transform duration-500 border-4 border-atomic-orange/20">
              <img alt="Roll On Painting Project" className="w-full h-auto object-fill" src="https://res.cloudinary.com/dxqfou8jh/image/upload/v1745866861/PXL_20240209_164221623.PANO_t6iosa.jpg" />
            </div>
          </div>
        </div>
      </div>
